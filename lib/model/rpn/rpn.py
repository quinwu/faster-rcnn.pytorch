...
class _RPN(nn.Module):
    ...
    def forward(self, base_feat, im_info, gt_boxes, num_boxes):
        ...
        regression coeffientes to generate transformed anchors. 
        ...
        if self.training:
            ...
            optimization to train the RPN network. The loss function is 
            a combination of:
             - The proportion of bounding boxes produced by RPN that are
